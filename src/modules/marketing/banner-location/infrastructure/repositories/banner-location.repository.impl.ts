...
import { IBannerLocationRepository, BannerLocationFilter } from '../../domain/banner-location.repository';

@Injectable()
export class BannerLocationRepositoryImpl extends PrismaRepository<
    BannerLocation,
