...
import { IPostCategoryRepository, PostCategoryFilter } from '../../domain/post-category.repository';

@Injectable()
export class PostCategoryRepositoryImpl extends PrismaRepository<
    PostCategory,
