...
import { IAboutRepository, AboutFilter } from '../../domain/about.repository';

@Injectable()
export class AboutRepositoryImpl extends PrismaRepository<any> implements IAboutRepository {
