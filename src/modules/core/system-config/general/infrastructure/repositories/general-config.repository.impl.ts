...
import { IGeneralConfigRepository, GeneralConfigFilter } from '../../domain/repositories/general-config.repository';

@Injectable()
export class GeneralConfigRepositoryImpl extends PrismaRepository<
    GeneralConfig,
