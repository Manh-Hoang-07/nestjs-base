  ...
  async seed(): Promise<void> {
    ...
    const menuData = [
      ...
      // ========== LOCATION MODULE ==========
      {
        ...
        is_public: false,
        show_in_menu: true,
        permission_code: 'location.manage',
        permission_codes: ['location.manage', 'country.manage', 'province.manage', 'ward.manage'],
      },
      {
        code: 'location-countries',
        name: 'Quốc gia',
        path: '/admin/location/countries',
        api_path: 'api/admin/location/countries',
        icon: '🏳️',
        type: MenuType.route,
        status: BasicStatus.active,
        parent_code: 'location-management',
        sort_order: 10,
        is_public: false,
        show_in_menu: true,
        permission_code: 'country.manage',
      },
      {
        code: 'location-provinces',
        name: 'Tỉnh/Thành phố',
        path: '/admin/location/provinces',
        api_path: 'api/admin/location/provinces',
        icon: '📍',
        type: MenuType.route,
        status: BasicStatus.active,
        parent_code: 'location-management',
        ...
        is_public: false,
        show_in_menu: true,
        permission_code: 'province.manage',
      },
      {
        code: 'location-wards',
        name: 'Phường/Xã',
        path: '/admin/location/wards',
        api_path: 'api/admin/location/wards',
        icon: '🏡',
        type: MenuType.route,
        status: BasicStatus.active,
        parent_code: 'location-management',
